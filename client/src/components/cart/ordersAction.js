...
import truck from '../dynamic/images/truck-icon.png'
                            ...
                            <div className='row order-items'>
                                ...
                                {products.map((product,index)=>{
                                    ...
                                    <tr style={{borderBottom:'2px solid #F5F5F5'}}>
                                        ...
                                        <span style={{color:'#F58C6F'}}>{product.item.name}</span>
                                        </td>
                                        <td style={{width:'68px'}}>
                                        <span>PKR {product.item.price}</span>
                                        </td>
                                        <td style={{width:'42px'}}>
                                        <span>{product.quantity}</span>
                                        </td>
                                        <td style={{width:'68px'}}>
                                         <span>PKR {product.productTotal}</span>
                                        </td>
                                    </tr>
                                    )
                                })}
                        ...
                        <div className='col-lg-4 '>
                            ...
                            <div className='row general-details'>
                                ...
                                <div className=' general-data'>
                                    <p><strong>Order Status:</strong> <span></span></p>
                            ...
                            <p style={{borderBottom:'2px solid #F5F5F5', paddingBottom:'8px'}}><strong>Earning From Order:</strong> <span><strong>PKR {order.orderTotal}</strong></span></p>
                                    {/* <hr/> */}
                                    <p><strong>Customer:</strong> <span style={{color:'#F58C6F'}}> {name}</span></p>
