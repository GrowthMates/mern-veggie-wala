            ...
            <div>
                ...
                <div className='container' >
                               ...
                               {this.state.checked!==true? void 0 :        
                                ...
                                <div className='row' >
                                    <div className='col' >
                                        ...
                                        <button type='button' className='btn  btn-danger btn-block' onClick={this.allCartSelect.bind(this)} style={{backgroundColor: '#FB005B'}} >Add To all Cart</button>
                                    </div>
                                </div>
                    ...
                    <div className='col' >
                        <div className='' >
                            <div  >
                                <button onClick={this.onSubmit.bind(this)} className='btn' style={{padding: '4px 30px', backgroundColor: '#FF4747', fontWeight: '600',fontSize: '19px',color: '#ffffff'}} >Add Product </button>
                                <hr/>
