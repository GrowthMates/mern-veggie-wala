                    ...
                    <div class='container' >
                        ...
                        <div className='row contact-mid-top'>
                            <div className='col-lg-5 col-md-5 col-xs-5'>
                                <img src={ContactUsImages.locationIcon} style={{width: '6%'}}/>
                            ...
                            <div className='col-lg-4 col-md-4 col-xs-4' style={{textAlign:'center'}}>
                                <img src={ContactUsImages.phoneIcon} style={{width: '10%'}}/>
                                <p style={{paddingTop:'1.5em'}}> (021) 341 650 49 , 92 300 219 1878</p>
                            </div>
                            <div className='col-lg-3 col-md-3 col-xs-3'>
                                <img src={ContactUsImages.mailIcon} style={{width: '12%'}}/>
                            ...
                            <div class="col-sm-12 col-lg-12  contact-us-form">
                                ...
                                <form>
                                    ...
                                    <div className='' >
                                        ...
                                        <textarea placeholder='Message' class="form-control" id="exampleFormControlTextarea1" rows="10"></textarea>
                                    </div>
                                    <button type="submit" class="contact-us-send-btn">Submit</button>
                                </form>
                            </div>
